...
public:
    ...
    void setupUi(QDialog *settingsDialog)
    {
        ...
        gridLayout->addItem(horizontalSpacer_6, 10, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_5, 10, 0, 1, 1);
        ...
        toolButton_6 = new QToolButton(settingsDialog);
        toolButton_6->setObjectName("toolButton_6");
        toolButton_6->setMinimumSize(QSize(30, 25));

        gridLayout->addWidget(toolButton_6, 8, 2, 1, 1);
